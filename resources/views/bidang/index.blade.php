			...
			<div class="card">
				<div class="card-body">
					<h4 class="header-title">
						Daftar Bidang Desa
						<a href="{{ route('bidang.create') }}" style="margin-left: 10px" class="btn btn-primary btn-xs"><i class="ti-plus"></i> Tambah</a>
					</h4>
